...
class Scores():
    ...
    def image_high_score(self):
        self.high_score_image = self.font.render('High score: ' + str(self.stats.high_score), True, self.text_color, (0, 0, 0))
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx - 10
    ...
    def image_ships(self):
        ...
        for ship_number in range(self.stats.lifes):
            ship = StarShip(self.screen, size='small')
